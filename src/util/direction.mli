...
(** [complement dlst] is an ordered-set-like list of cardinal directions that
    complements [dlst] which together forms [dir_list]. The complement of
    [dir_list] is the empty list.*)
